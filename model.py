...
data = pd.read_csv("D:\Personal Projects\Programing\pyth pr\Heart Desease Project\heart_desease_data.csv")
data.info()
...
rf1 = RandomForestClassifier(n_estimators=15, max_depth=3)
rf1.fit(X_train, y_train.values.ravel())
rf2 = RandomForestClassifier(n_estimators=50, max_depth=3)
rf2.fit(X_train, y_train.values.ravel())
rf3 = RandomForestClassifier(n_estimators=40, max_depth=None)
...
print("\n Max Depth: {} || Estimators: {} || Acuracy: {} || Precision: {} || Recall: {}".
      format(rf1.max_depth, rf1.n_estimators, accuracy, precision, recall))
...
#print(model.predict([2, 9, 4, 4, 6, 8, 3, 2, 1, 5, 4, 3, 1]))
